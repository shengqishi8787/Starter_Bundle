...
def predict(X, W):
    ...
    # apply a step function to threshold the outpus to binary class labels
    preds[preds <= 0.5] = 0
    preds[preds > 0.5] = 1
...
for epoch in np.arange(0, args["epochs"]):
    ...
    # then pass this value through our sigmoid activation function, thereby
    ...
    # the gradient descent update is the dot product between our features
